...
public class NodeQueue extends Queueability implements Queuing {
    ...
    public Queueable updateQueue(){
        Queueable cache = head;

        head = cache.getTail();                 //  updateQueue_ext_02
        head.setHead(null);                     //  updateQueue_ext_03
        cache.setTail(null);                    //  updateQueue_ext_04


        return cache;                           //  updateQueue_ext_01
    }
